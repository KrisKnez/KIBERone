...
const Contact = () => {
  ...
  const onSubmit = (data) => window.open(`https://wa.me/385953943344?text=${(data.question)}`, '_blank').focus();
    ...
    >
      ...
      <div className="basis-1/2 px-8 py-12">
        ...
        <div className="relative">
          ...
          <form className="relative bg-white shadow-lg w-full h-full rounded-3xl p-8 space-y-3" onSubmit={handleSubmit(onSubmit)}>
            <label
              htmlFor="tel"
